  ...
  return (
    <div>
        ...
        <h3 className='text-3xl py-2 font-bold text-center font-serif my-4'>Why Us</h3>
            <div className='flex pt-4 justify-center font-semibold text-center  gap-3'>
                <div className='py-4  px-4 rounded-lg border border-b-4  bg-gray-300'>
              ...
              <p> Our team includes professionals, specialists, and passionate hobbyists who bring diverse perspectives.</p>
                ...
                <div className='py-4  px-2 rounded-lg border border-b-4  bg-gray-300'>
